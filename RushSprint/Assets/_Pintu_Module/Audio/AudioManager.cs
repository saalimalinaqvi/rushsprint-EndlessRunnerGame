...
public class AudioManager : MonoBehaviour
{
    ...
    public float defaultVolumeMusic = 0.12f;
    public float defaultVolumeUI = 0.12f;
    public float defaultVolumeSFX = 0.5f;
	...
	{
		InitMixer();
		SetVolumeMusic(defaultVolumeMusic);
        SetVolumeUI(defaultVolumeUI);
        SetVolumeSFX(defaultVolumeSFX);
	}
	...
	public enum MixerTarget { None, Default, SFX, UI, Music }
	public enum DefaultMixerTarget { None = MixerTarget.None, SFX = MixerTarget.SFX, UI = MixerTarget.UI, Music = MixerTarget.Music }
